...
import com.synapse.clinicafemina.service.FollowUpConfigService;
...
@RestController
@RequestMapping("/api/follow-up/config")
@RequiredArgsConstructor
public class FollowUpConfigController {

    private final ClinicaConfigService clinicaConfigService;
    private final FollowUpConfigService service;

    @GetMapping
    @PreAuthorize("hasRole('GESTOR')")
    public List<FollowUpConfigResponse> listar() {
    ...
    @PreAuthorize("hasRole('GESTOR')")
    public FollowUpConfigResponse criar(@RequestBody @Valid FollowUpConfigRequest request) {
        Clinica clinica = clinicaConfigService.obterClinicaAtual();
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('GESTOR')")
    public FollowUpConfigResponse atualizar(@PathVariable Long id,
                                            @RequestBody @Valid FollowUpConfigRequest request) {
        Clinica clinica = clinicaConfigService.obterClinicaAtual();
    ...
    @PreAuthorize("hasRole('GESTOR')")
    public FollowUpConfigResponse alterarStatus(@PathVariable Long id,
